...
function getLinearEquationRoot(a, b) {
    return -b/a;                        // при б=0 выдает -0б можбыть ошибка!!!11
}
 ...
 *   (0,-1) (1,0)    => π/2
 *   (0,1) (0,1)     => 0
 *   (0,1) (1,2)     => 0    // непонятно нужно ли это  округлять до нуля, тк по факту это не нуль !!!!!111111
 */
function getAngleBetweenVectors(x1, y1, x2, y2) {
    let cos = (x1*x2 + y1*y2)/Math.sqrt((Math.pow(x1, 2) + Math.pow(y1, 2))*(Math.pow(x2, 2) + Math.pow(y2, 2))); // может быть ошибка тк нет округления
